...
fn output_device_priority(device_type: oboe::AudioDeviceType) -> u8 {
    match device_type {
        oboe::AudioDeviceType::UsbDevice
        | oboe::AudioDeviceType::UsbHeadset
        | oboe::AudioDeviceType::UsbAccessory
        | oboe::AudioDeviceType::Dock => 0,
        oboe::AudioDeviceType::WiredHeadphones
        | oboe::AudioDeviceType::WiredHeadset
        | oboe::AudioDeviceType::LineAnalog
        | oboe::AudioDeviceType::LineDigital
        | oboe::AudioDeviceType::Hdmi
        | oboe::AudioDeviceType::HdmiArc
        | oboe::AudioDeviceType::HdmiEarc => 1,
        oboe::AudioDeviceType::BluetoothA2DP
        | oboe::AudioDeviceType::BluetoothSCO
        | oboe::AudioDeviceType::BleBroadcast
        | oboe::AudioDeviceType::BleHeadset
        | oboe::AudioDeviceType::BleSpeaker
        | oboe::AudioDeviceType::HearingAid => 2,
        oboe::AudioDeviceType::BuiltinSpeaker
        | oboe::AudioDeviceType::BuiltinSpeakerSafe
        | oboe::AudioDeviceType::BuiltinEarpiece => 3,
        _ => 4,
    }
}
...
impl HostTrait for Host {
    ...
    fn default_output_device(&self) -> Option<Self::Device> {
        if let Ok(mut devices) = oboe::AudioDeviceInfo::request(oboe::AudioDeviceDirection::Output)
        {
            devices.sort_by_key(|device| output_device_priority(device.device_type));
            if let Some(device) = devices.into_iter().next() {
                return Some(Device(Some(device)));
            }
        }
...
fn configure_output_builder<C, T>(
    builder: oboe::AudioStreamBuilder<oboe::Output, C, T>,
) -> oboe::AudioStreamBuilder<oboe::Output, C, T> {
    let builder = if oboe::AudioStreamBuilder::<oboe::Output, C, T>::is_aaudio_supported() {
        builder.set_audio_api(oboe::AudioApi::AAudio)
    } else {
        builder
    };
...
where
    ...
    E: FnMut(StreamError) + Send + 'static,
{
    let builder = configure_output_builder(configure_for_device(builder, device, config));
    let stream = builder
